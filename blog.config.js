...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DreamStar0707', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的自由主义者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.jxbeautystar.xyz/', // 网站地址
